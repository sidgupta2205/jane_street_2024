...
if load_model:
    mlp.load_state_dict(torch.load(f'{model_save_dir}/torchcustomwithencoder.pth',weights_only=True))
    print("Model loaded")
...
for i in range(0,iterations-200,200):
    ...
    if evaluate:
        ...
        for epoch in range(epochs):
            ...
            if val_r2 > best:
                ...
                torch.save(best_model.state_dict(), f'torchcustomwithencoder_{i}_iteration.pth')
                degraded = 0
